...
public class DailyPlan extends JExtendedFrame implements TableModelListener{
    ...
    private void initComponents()
    {
        ...
        hozzaadMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/add.png"))); // NOI18N
        ...
        riportMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/report.png"))); // NOI18N
        ...
        muszakTeljesit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/report.png"))); // NOI18N
        muszakTeljesit.setText("Napi jelentés");
        muszakTeljesit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void riportMenuActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Report("reports/napiterv.jrxml",cfg.sqlDate(Datum.getDate()));
    }
    ...
    private void muszakTeljesitActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Report("reports/muszakteljesit.jrxml",cfg.sqlDate(date));
    }
    ...
    private void Report(String reportName, String datum)
    {
        ParametersClear();
        Configuration cfg = new Configuration();
        if (reportName.compareTo("reports/napiterv.jrxml") == 0)
        {
...
//            cfg.setParamValue(mLista.elementAt(Munkahely.getSelectedIndex()).getValue(), 4);
            cfg.setParamName("datum", 0);
            cfg.setParamValue(datum,0);
            cfg.setParamName("uzemfilter", 1);
            cfg.setParamValue(Integer.toString(ComboID(Munkahely)), 1);
            cfg.setParamName("uzemnev", 2);
            cfg.setParamValue(ComboVAL(Munkahely), 2);
        }
        else
        {
            cfg.setParamName("datum", 0);
            cfg.setParamValue(datum,0);
            cfg.setParamName("user", 1);
            cfg.setParamValue(cfg.getcurrentUserName(),1);
        }
