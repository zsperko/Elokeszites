...
public class Configuration {
    ...
    public void ment()
    {
        ...
        try
        {
            ...
            ObjectOutputStream objOut = new ObjectOutputStream(new FileOutputStream("config.dat"));
    ...
    public void beolvas()
    {
        ...
        {
            Array = null;
            ObjectInputStream objIn = new ObjectInputStream(new FileInputStream("config.dat"));
    ...
    public void setreportName(String ertek)
    {
        reportName = ertek;
    }
    ...
    public void setParamName(String ertek, int index)
    {
        Pname[index] = ertek;
    }
    ...
    public void setParamValue(Object ertek, int index)
    {
        Pvalue[index] = ertek;
    }
