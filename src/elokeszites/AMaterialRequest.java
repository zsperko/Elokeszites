...
public class AMaterialRequest extends JExtendedFrame implements TableModelListener{
    ...
    private void initComponents()
    {
        ...
        szamolMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/calculator.png"))); // NOI18N
        ...
        osszetettriportMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/report_simple.png"))); // NOI18N
        osszetettriportMenu.setText("Üzemi anyagigénylési lap");
        osszetettriportMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        reszletesriportMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/report_dif.png"))); // NOI18N
        reszletesriportMenu.setText("Részletes riport");
        reszletesriportMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        teruletMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/reportarea.png"))); // NOI18N
        teruletMenu.setText("Raktári anyagigénylési lap");
        teruletMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        visszaadMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/elokeszites/icons/transfer.png"))); // NOI18N
        visszaadMenu.setText("Visszaadandó anyagok");
        visszaadMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Muszak.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Anyagigenytabla();
            }
        });

        Periods.addItemListener(new java.awt.event.ItemListener() {
        ...
        if (valaszt == 0)
        {
            try
            {
                ...
                if (rSet.next())
                {
                    ...
                    Date fromDate = Datum.getDate();
                    fromDate = DateCalc(date);
            ...
            switch (valaszt)
            {
                case 1:
                    ...
                    sqlupdate("UPDATE temp_anyagigeny INNER JOIN (SELECT keszlet.cikkszam,sum(keszlet.mennyiseg) AS mennyiseg "
                            + "FROM keszlet WHERE (keszlet.raktar = 'FURNÉR KÖZ') OR (keszlet.raktar = 'SVARTNI') GROUP BY "
    ...
    private void Report(int valaszt)
    {
        ...
        if (DoReport)
        {
            ...
            {
                TableMake(1);
                riportName = "reports/osszetettanyagigeny.jrxml";
            }
            else if (valaszt == 2)
            {
                TableMake(2);
                riportName = "reports/reszletesanyagigeny.jrxml";
            }
            else if (valaszt == 3)
            {
                TableMake(1);
                riportName = "reports/anyagigenyterulet.jrxml";
            }
            else if (valaszt == 4)
            {
                VisszaadTabla();
                riportName = "reports/visszaadando.jrxml";
                Calendar cal = Calendar.getInstance();
                Date datum = cal.getTime();
                startdate = cfg.sqlDate(datum);
            }
            cfg.setParamName("user", 0);
            cfg.setParamValue("admin", 0);
            cfg.setParamName("startdate", 1);
            cfg.setParamValue(startdate, 1);
            cfg.setParamName("enddate", 2);
            cfg.setParamValue(enddate, 2);
            cfg.setParamName("startmuszak", 3);
            cfg.setParamValue(startmuszak, 3);
            cfg.setParamName("endmuszak", 4);
            cfg.setParamValue(endmuszak, 4);
