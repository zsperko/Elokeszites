...
public class Connect extends JExtendedFrame{
    ...
    private void initComponents()
    {
        ...
        mentesMenu.addActionListener((java.awt.event.ActionEvent evt) -> {
        ...
        testMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/test.png")));
        testMenu.setText("Kapcsolat teszt");
        testMenu.addActionListener((java.awt.event.ActionEvent evt) -> {
